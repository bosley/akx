...
static akx_cell_t *iter_list(akx_runtime_ctx_t *rt, akx_cell_t *list,
...
static akx_cell_t *iter_string(akx_runtime_ctx_t *rt, const char *str,
                               akx_cell_t *lambda_cell) {
...
static akx_cell_t *iter_integer(akx_runtime_ctx_t *rt, int value,
                                akx_cell_t *lambda_cell) {
  int result = 0;
...
static akx_cell_t *iter_real(akx_runtime_ctx_t *rt, double value,
                             akx_cell_t *lambda_cell) {
  union {
    double d;
    uint64_t u;
...
akx_cell_t *iter_impl(akx_runtime_ctx_t *rt, akx_cell_t *args) {
  ...
  case AKX_TYPE_CONTINUATION:
    akx_rt_error_fmt(rt,
                     "iter: cannot iterate over type %d (lambda, symbol, "
                     "quoted, or continuation)",
                     value_type);
    break;
